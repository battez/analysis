...
if __name__ == "__main__":
    ...
    most_recent = dir_model + 'Mac_d2v_tol0001_win10_420kseed40_160se4_ep2_minc8'
    ...
    if True:
        ...
        model_DM = Doc2Vec(size=vecs, window=10, min_count=8, sample=1e-4,\
         negative=5, workers=cores,  dm=1, dm_concat=1 )
        model_DBOW = Doc2Vec(size=vecs, window=10, min_count=8, sample=1e-4,\
    ...
    print('light thunde similarity', model_DM.similarity('lightning', 'thunder'))
